...
window.onload = function () {
  ...
  var navNotAtTop = false; // Header image animation

  var header = document.querySelector(".header__background");
  var windowScroll;
  var moveHeaderImage = true; // Align section vertically when scrolled into view

  var align = "center"; // Scroll delay after link is clicked in navigation bar

  var scrollDelay = 0; // Scroll behavior depending on screen width

  var scrollBehavior = function scrollBehavior() {
  ...
  var navOpenClose = function navOpenClose() {
  ...
  navBarUnderline[navCurrentPage.firstElementChild.dataset.menu].classList.add("show");
  ...
  navBar.addEventListener("mouseover", function (e) {
    ...
    if (!currentMenu || currentMenu.firstElementChild.dataset.menu === "Logo") return;
    navBarUnderline.forEach(function (el) {
  ...
  navBar.addEventListener("click", function (e) {
    ...
    if (!currentMenu || currentMenu.parentElement.firstElementChild.dataset.menu === "Logo") return;
    var scrollToSection = document.querySelector(currentMenu.getAttribute("href")); // If there is a scollDelay of 550, then it is in phone mode so
